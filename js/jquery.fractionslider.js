...
(function (e) {
    ...
    var r = function (t, n) {
        ...
        function P() {
            var t = i.currentSlide.children(), n = 0;
            t.each(function () {
        ...
        function j() {
            ...
            var i = t.attr("data-position"), s = t.attr("data-in"), u = t.attr("data-delay"), a = t.attr("data-time"),
                f = t.attr("data-ease-in"), l = t.attr("data-special");
            if (i == null) {
                i = n.position.split(",")
            } else {
                i = i.split(",")
        ...
        function I() {
            ...
            t.each(function () {
                var t = e(this), r = t.position(), i = t.attr("data-out"), s = t.attr("data-ease-out");
                if (i == null) {
                    i = n.transitionOut
                }
                if (s == null) {
        ...
        function q() {
            var e = i.currentSlide, t = {}, r = {}, s = n.slideTransitionSpeed, o = i.animation;
            if (n.responsive) {
                unit = "%"
            } else {
                unit = "px"
        ...
        function R() {
            var e = {}, t = {}, r = n.slideTransitionSpeed, s = null, o = i.animation;
            if (n.responsive) {
                s = "%"
            } else {
                s = "px"
        ...
        function z(e, t, r, i, s) {
            ...
            var h = e.outerWidth(), v = e.outerHeight();
            if (n.responsive) {
                h = K(h, u);
                v = K(v, a)
            }
        ...
        function W() {
            ...
            r = r.split(" ");
            var i = n.backgroundX, s = n.backgroundY, o = Number(r[0].replace(/[px,%]/g, "")) + Number(i),
        ...
        function X() {
            ...
            r.each(function () {
                var t = e(this), n = null, r = null, i = null;
        ...
        function V() {
            var e = f.innerWidth(), t = f.innerHeight();
            if (e <= u) {
                var i = u / a, s = e / i;
                f.find(".fs-stretcher").css({width: e + "px", height: s + "px"})
            }
            var o = f.width();
            p = K((h - o) / 2, u);
            c = 100;
        ...
        function J() {
            var t = null, n = null, r = f.children(".slide").find("*");
            r.each(function () {
                obj = e(this);
        ...
        var r = {
            ...
            maxObjs: 0,
            finishedObjs: 0
        }, i = {currentSlide: null, lastSlide: null, animationkey: "none"}, s = [], o = null, u = null, a = null;
        e(t).wrapInner('<div class="fraction-slider" />');
        var f = e(t).find(".fraction-slider"), l = null;
        r.maxSlide = f.children(".slide").length - 1;
        var c = f.width(), h = e("body").width(), p = 0;
        if (n.fullWidth) {
            p = (h - c) / 2;
            c = h
        }
